...
class Auth {
  ...
  static List<Uint8List> buildAuthPackets({
    ...
    packets.add(_addCrc([
      ...
      0x08, 0x05, 0x10, 0x0E, 0x22, 0x02, 0x08, 0x02, // f4.f1=2 — REQUIRED for wake detection
    ]));
    ...
    packets.add(_addCrc([
      ...
      0x08, 0x05, 0x10, 0x12, 0x22, 0x02, 0x08, 0x02, // f4.f1=2 — keep wake detection registered
    ]));
